...
def main():
    ...
    while True:
        ...
        #input_object["BBoxes_xyxy"]["ROI"] = [100.0, 100.0, 200.0, 200.0]

        # URL of the Flask server
        url = 'http://localhost:5000/add_message'
        json_data = json.dumps(input_object)
